...
var person1:{name:string,userName:string,accountNumber:number,PIN:number,balance:number}={
name:"Hafsa Noor",
userName:"hafsa822",
accountNumber:12345,
PIN:4444,
...
//simple withdrawal
   ...
   //verification for multiple of 500
...
//asking if they want to repeat the transaction
